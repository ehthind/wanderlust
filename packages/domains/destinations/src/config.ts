import type { DestinationMapTourView } from "@wanderlust/shared-schemas";

export const discoverDestinationIds = ["dest_paris", "dest_kyoto", "dest_mexico_city"] as const;
export const featuredDestinationId = discoverDestinationIds[0];
...
export const destinationMapTours: Record<string, DestinationMapTourView> = {
  dest_paris: {
    title: "Paris Arrondissement Tour",
    summary:
      "Move through the historic core, the Left Bank, and Montmartre so Paris reads as a sequence of districts instead of isolated landmarks.",
    autoplay: true,
    stops: [
      {
        ...
        subtitle:
          "Open on the historic center so the Louvre, river crossings, and island edge read as one dense district.",
      ...
      },
      {
        ...
        subtitle:
          "Drift west through Saint-Germain and the 7th so the boulevard rhythm feels lived in, not monumental.",
      ...
      },
      {
        ...
        subtitle:
          "Finish in the 18th so the hill and street grain give Paris a final sense of elevation and texture.",
  ...
  dest_kyoto: {
    ...
    summary:
      "Move from temple hills to Gion and then out to Arashiyama so the city feels slower, greener, and more spatially distinct.",
    autoplay: true,
    stops: [
      {
  ...
  dest_mexico_city: {
    ...
    summary:
      "Cut between Chapultepec, Roma-Condesa, and the historic center so the city feels broad, green, and densely alive.",
    autoplay: true,
    stops: [
      {
      ...
      },
      {
        ...
        subtitle:
          "Bring the camera down into the tree-lined grid where the trip usually lives day to day.",
      ...
      },
      {
        ...
        subtitle:
          "Finish in the monumental core so the historic center feels like its own city chapter.",
